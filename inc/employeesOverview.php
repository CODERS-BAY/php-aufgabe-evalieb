        ...
        <table class="table">        
            ...
            <tbody>
                ...
                while($datensatz=$result->fetch_object()){
                    ...
                    <form class='formular' onsubmit='return deleteForSure("<?php echo $username ?>")'>
                        <tr class='row noBreak'>
                            ...
                            <td class='col-2'><?php echo $datensatz->rights_name ?></td>
                            <td class='col-2'><?php echo $datensatz->team_name ?></td>
                            <td class='col-1'><input type='submit' class='inTD' value='löschen'> </td>
                            <td class='col-1'><input type='submit' class='inTD' value='bearbeiten'></td>
                        </tr>
                    </form>
                <?php }
